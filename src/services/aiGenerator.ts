...
### 反馈结构（按此顺序组织）
1.【开头】用名字（不带姓）开头，整体表现评价（活跃/认真/进步/安静等），2-3句话
2.【中间】本节课重点学习了【课程内容】，在【优势方面】表现很好，需要加强的是【薄弱环节】。引用课堂上的具体互动细节（如"老师问XXX时，能够XXX"）
3.【建议】建议课后多【具体练习建议，如听音频跟读、做练习册等】，家长可以【亲子互动建议，如和孩子一起XXX】
4.【结尾】鼓励性话语，"很棒，继续保持哦~""期待下次更精彩的表现！"
...
function generateFallback(note: StudentNote, courseContent: string, additionalPrompt: string): GenerateResult {
  ...
  const templates: Record<PerformanceLevel, (name: string, topic: string, perf: string, extra: string) => string> = {
    excellent: (n, t, p, e) =>
      `${n}今天的学习状态非常不错呢~课堂上能够积极地响应老师的提问，很棒！今天我们学习了${t}的内容，对新知识点的理解非常到位，课堂上老师提问时能够准确回答，掌握得很扎实哟。${p ? p + '~' : ''}建议课后可以多听音频跟读，把今天学到的知识点再巩固一下，同时也可以适当做一些拓展练习来加深理解。家长可以多鼓励孩子开口说英语，培养自信心。很棒，继续保持哦！${e}`,

    good: (n, t, p, e) =>
      `${n}今天整体表现挺不错的~课堂上能够跟上老师的节奏，学习态度认真积极。今天我们学习了${t}，在知识点的理解上还不错，${p ? p + '。' : '部分内容掌握得比较好。'}需要加强的地方是课后要多听多读，特别是今天学到的重点内容，建议每天坚持听读练习10-15分钟。家长可以在课后多和孩子进行简单的英语互动，帮助把所学内容运用到生活中。很有潜力，持续努力一定会取得更大的进步！${e}`,

    improve: (n, t, p, e) =>
      `${n}今天的学习态度总体还是认真的，不过有几个地方我们再熟悉一下哟~${p ? p + '~' : ''}今天学习了${t}的内容，对部分知识点的理解还需要再巩固一下。建议课后认真复习今天的内容，可以对照笔记把知识点过一遍，有不明白的地方及时向老师请教。家长方面可以多鼓励孩子，帮助建立学习英语的信心。每天固定15-20分钟的英语学习时间，也可以通过英语歌曲、小游戏来激发学习兴趣。老师相信一定能取得进步，加油哟！${e}`,

    absent: (n, t, p, e) =>
      `${n}本节课缺勤了，错过了${t}的学习内容。${p ? p + '。' : '这节课我们重点讲解了新的知识点，还进行了相关的练习活动。'}建议尽快找同学借笔记或询问老师，补上今天的学习内容。课后作业也需要按时完成哟。家长方面请协助督促孩子在家完成复习和预习工作。期待下节课看到回来上课！${e}`,

    progress: (n, t, p, e) =>
      `${n}今天相比之前有明显进步呢，老师为你感到非常高兴~${p ? p + '~' : ''}课堂上更加主动积极了，遇到不懂的问题也能及时提问，在互动环节中也越来越自信。对${t}的掌握程度在稳步提升，口语表达方面比之前更加流畅了。建议课后多听多读，坚持每天练习，把今天学到的知识点反复巩固。进步趋势很好，说明正在找到适合自己的学习方法。继续保持这种积极的学习态度，老师很期待下次更精彩的表现！${e}`,
  };
  ...
  if (text.length < 150) {
    const tails: Record<PerformanceLevel, string> = {
      ...
      improve: '只要有恒心和毅力，每天进步一点点，终会收获满意的成绩。老师和家长都会一直支持孩子的学习！',
        absent: '请家长关注孩子的出勤情况，确保不缺席重要课程。学习贵在坚持，相信补上落下的内容后一定能跟上进度！',
        progress: '这种进步的势头非常可贵，老师和同学们都为孩子感到骄傲。继续保持，未来可期！',
    };
